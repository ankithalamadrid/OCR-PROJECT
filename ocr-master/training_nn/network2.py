...
class Network(object):
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        for j in xrange(epochs):
            ...
            np.save('biases_weights/biases'+str(self.accuracy(evaluation_data)/float(n_data)*100), self.biases)
            np.save('biases_weights/weights'+str(self.accuracy(evaluation_data)/float(n_data)*100), self.weights)
